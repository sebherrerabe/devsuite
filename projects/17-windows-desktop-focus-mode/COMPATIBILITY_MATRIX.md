...
| Website block-list enforcement               | Not enforced                                       | Hosts-based hard block during active sessions plus signal-aware reminders/fallback audits | Same settings schema; enforcement desktop-only                                            | `partial` | `apps/desktop/src/main.ts`, `apps/desktop/src/strict-policy-engine.ts`                    |
