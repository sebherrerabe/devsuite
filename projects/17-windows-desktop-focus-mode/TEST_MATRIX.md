...
- `P1` cases must pass for release candidates; failures require explicit waiver in `STATUS.md`.
...
| `pnpm --filter @devsuite/desktop test:e2e`           | WebdriverIO Electron E2E               |
| `pnpm --filter @devsuite/desktop test:install-smoke` | Installer first-run smoke on clean VM  |
